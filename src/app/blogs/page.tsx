    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>Summit Door Pros — Blog Center</h1>
          <p className={styles.pageSubtitle}>
            Practical garage door safety tips, spring & cable repair guidance, and door maintenance advice for Central Texas homeowners.
          </p>
        </motion.div>
      </section>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need a licensed garage door technician in Central Texas?
            </p>
            <p className={styles.blogCTABody}>
              We&apos;ve been powering Waco-area homes and businesses with expert garage door repair, spring & cable repair, and installations since 2011. Free estimate, no obligations.
            </p>
