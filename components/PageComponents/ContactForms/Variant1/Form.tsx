...
const SERVICES = [
  { icon: faWrench,          label: 'Garage Door Repair' },
  { icon: faLink,            label: 'Spring & Cable' },
  { icon: faDoorOpen,        label: 'New Door Install' },
  { icon: faCogs,            label: 'Opener Install' },
  { icon: faClipboardList,   label: 'Maintenance Plan' },
  { icon: faBuilding,        label: 'Commercial Doors' },
...
const TRUST_CHIPS = [
  ...
  { icon: faStar,         text: '4.9★ · 800+ reviews' },
];
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A licensed Summit Door Pros technician will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12547201100"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 720-1100', section: 'ContactForm-V1' })}>
                          Call (254) 720-1100
                        </a>
                      </span>
                    </div>
