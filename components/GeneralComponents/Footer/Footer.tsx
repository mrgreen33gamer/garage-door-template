...
const SERVICE_LINKS = [
  ...
  { href: '/services/spring-cable-repair',         label: 'Spring & Cable Repair' },
  { href: '/services/new-door-installation',        label: 'New Door Installation' },
  { href: '/services/opener-installation',  label: 'Opener Installation' },
  { href: '/services/door-maintenance',label: 'Door Maintenance Plans' },
  { href: '/services/commercial-doors', label: 'Commercial Doors' },
];
...
const TRUST_ITEMS = [
  ...
  { icon: faWrench,       label: 'IDA-Trained' },
  { icon: faClock,        label: 'Same-Day Service' },
  { icon: faBolt,         label: 'Lifetime Spring Warranty' },
];

const SOCIALS = [
  { href: 'https://facebook.com/summitdoorpros', icon: faFacebookF, label: 'Facebook' },
  { href: 'https://g.page/r/summitdoorpros',     icon: faGoogle,    label: 'Google' },
];
          ...
          <div className={styles.brandCol}>
            <Link href="/" className={styles.logo}>
              ...
              <div className={styles.logoText}>
                <span className={styles.logoName}>Summit Door Pros</span>
