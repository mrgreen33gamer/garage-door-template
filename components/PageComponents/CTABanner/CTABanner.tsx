...
export default function CTABanner({
  ...
  spot = "CTABanner",
  imageSrc,
  eyebrow = "Summit Door · Central Texas",
  badgeA = "Same-Day",
  badgeB = "Springs",
  badgeC = "Openers",
}: CTABannerProps) {
  ...
  return (
    <section className={styles.banner} aria-label="Call to action">
      ...
      <motion.div
        ...
        aria-hidden="true"
      >
        <svg width="380" height="380" viewBox="0 0 24 24" fill="currentColor"><path d="M6 2h9a2 2 0 0 1 2 2v18H6V2zm2 2v16h7V4H8zm5 7a1 1 0 1 1 0 2 1 1 0 0 1 0-2z" opacity="0.85"/></svg>
      </motion.div>
