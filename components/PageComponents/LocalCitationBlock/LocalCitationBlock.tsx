...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'Summit Door Pros',
  address       = 'Waco, TX 76701',
  phone         = '(254) 720-1100',
  email         = 'service@summitdoorpros.com',
  googleMapsUrl = 'https://maps.google.com/?q=Summit+Door+Pros+garage door+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with licensed garage door technicians.
          </p>
        </div>
