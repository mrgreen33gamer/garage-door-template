      ...
      <div className={styles.heroContainer}>
        ...
        >
          ...
          <h1 className={styles.heroTitle}>
            Central Texas garage door<br />
            <em>Done Right.</em><br />
            Every Time.
          </h1>
          <p className={styles.heroSubtitle}>
            Summit Door Pros has been keeping homes and businesses comfortable in{' '}
          ...
          <div className={styles.imageFrame}>
            <div className={styles.imageWrapper}>
              <Image
                ...
                alt="Summit Door Pros — Waco, Texas garage door technicians"
                fill
            ...
            <div className={styles.trustCard}>
              ...
              <div className={styles.trustCardText}>
                <span className={styles.trustCardTitle}>Summit Door Pros</span>
                <span className={styles.trustCardSub}>Waco's Most Trusted garage door</span>
              </div>
            </div>
          </div>
        </motion.div>
