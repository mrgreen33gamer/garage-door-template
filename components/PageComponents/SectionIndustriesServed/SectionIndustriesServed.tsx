...
const INDUSTRIES = [
  ...
  { slug: 'homebuilders',          label: 'Homebuilders & Remodelers', icon: faHardHat },
  { slug: 'commercial-facilities', label: 'Commercial Facilities',     icon: faIndustry },
];
...
export default function SectionIndustriesServed({
  ...
  subtitle = 'Garage door programs — built for how your industry actually works.',
  disableLinks = false,
