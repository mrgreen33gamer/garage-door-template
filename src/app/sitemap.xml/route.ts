...
export async function GET() {
  const baseUrl = 'https://www.summitdoorpros.com';
  ...
  // ── Core service pages ─────────────────────────────────────────────────────
  const coreServices = [
    { url: '/services/garage-door-repair',     priority: '0.95', changefreq: 'weekly'  },
    { url: '/services/spring-cable-repair',    priority: '0.90', changefreq: 'weekly'  },
    { url: '/services/new-door-installation',  priority: '0.90', changefreq: 'weekly'  },
    { url: '/services/opener-installation',    priority: '0.85', changefreq: 'monthly' },
    { url: '/services/door-maintenance',       priority: '0.85', changefreq: 'monthly' },
    { url: '/services/commercial-doors',       priority: '0.85', changefreq: 'monthly' },
  ];
