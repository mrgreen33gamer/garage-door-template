...
// Summit Door Pros — Service Areas Page
'use client';
...
const SERVICE_AREAS = [
  {
    ...
    badge:       'Home Base',
    description: 'Our headquarters. Fastest response times, same-day service available 7 days a week. Full garage door repair, spring & cable repair, track and hardware, lighting, door maintenances, and commercial doors across all of Waco.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: 'Full garage door coverage for Hewitt homes and businesses. Fast dispatch from our Waco base — typically under 45 minutes.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: "Serving Woodway's residential neighborhoods with the same flat-rate pricing and Lifetime Spring Warranty + 2-Year Workmanship as every other area we cover.",
    highlights:  ['Flat-rate pricing', 'Lifetime Spring Warranty + 2-Year Workmanship', 'IDA-trained'],
  },
  {
    city:        'Bellmead',
    slug:        'bellmead-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Reliable garage door service for Bellmead residents and businesses. Door System upgrades, repairs, and lighting installs — same-day when available.',
    highlights:  ['Residential & commercial', 'IDA-trained garage door technicians', 'No contracts'],
  },
  {
    city:        'China Spring',
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Rural and residential garage door service for the China Spring area. We make the drive — flat-rate pricing applies just the same.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Garage Door repair, spring & cable repair, and shop power for McGregor homes and light industrial properties.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Garage Door repair, installation, and upgrades for Killeen and Fort Cavazos area homes and businesses. Military-friendly scheduling.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Full-service garage door coverage for Temple. Medical district and surrounding neighborhoods served. Full residential and commercial garage door.',
...
const faq = [
  ...
  {
    question: 'Do you work on commercial garage door in all areas?',
    answer: 'Yes — light commercial garage door for restaurants, offices, retail spaces, and small warehouses is within scope across all our coverage areas. Call to discuss your specific project and location.',
  },
  {
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          ...
          >
            <div className={styles.heroBadge}>
              ...
              Central Texas Garage Door — Since 2011
            </div>
            ...
            <p className={styles.heroSub}>
              Based in Waco, serving all of Central Texas. Flat-rate pricing, IDA-trained garage door technicians, and a Lifetime Spring Warranty + 2-Year Workmanship — no matter where you are.
            </p>
            <div className={styles.heroActions}>
              <a href="tel:+12547201100" className={styles.heroCTAPrimary}>
        ...
        <div className={styles.areasSectionInner}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSub}>
              Click any city to see local service details, common garage door issues in your area, and what to expect from our team.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.areaFooter}>
                    <a href="tel:+12547201100" className={styles.areaCallBtn}>
      ...
      <section className={styles.unlisted}>
        <div className={styles.unlistedInner}>
          ...
          <a href="tel:+12547201100" className={styles.unlistedCTA}>
            Call (254) 720-1100
          </a>
        </div>
      </section>
      ...
      <CTABanner
        ...
        subline="Same-day service available across Central Texas. Flat-rate pricing, Lifetime Spring Warranty + 2-Year Workmanship, no contracts ever."
