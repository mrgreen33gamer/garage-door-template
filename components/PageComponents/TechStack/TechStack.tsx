...
const DEFAULT_GROUPS: BrandGroup[] = [
  ...
  },
  {
    ...
    items: [
      { name: 'IDA-Trained',        type: 'cert', icon: '✓' },
      { name: 'Lead Garage Door Technician',   type: 'cert', icon: '✓' },
...
const TechStack: React.FC<TechStackProps> = ({
  ...
  subtitle = 'We install and service major electrical brands — IDA-trained crews, no shortcuts on code or materials.',
