...
const DEFAULT_GUARANTEES: Guarantee[] = [
  ...
  {
    icon: faShieldHalved,
    title: "Lifetime Spring Warranty + 2-Year Workmanship",
    description:
      "Every installation we perform is covered for two full years of workmanship. If our work fails within 24 months, we make it right at no charge.",
  },
  {
    icon: faRotateLeft,
  ...
  },
  {
    ...
    description:
      "Every garage door technician who enters your home is IDA-trained. No unlicensed subs working alone — ever.",
  },
  {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.body}>
            Every garage door company in Central Texas makes promises. We back ours in writing — with flat-rate pricing, IDA-trained garage door technicians, and a Lifetime Spring Warranty + 2-Year Workmanship on every install we touch.
          </p>
          <Link
            href={ctaLink}
