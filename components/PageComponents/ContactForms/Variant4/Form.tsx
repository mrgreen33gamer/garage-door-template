...
const SERVICES = [
  { icon: faWrench,        label: 'Garage Door Repair',  sub: 'Off-track, rollers, noisy door' },
  { icon: faLink,          label: 'Spring & Cable',      sub: 'Broken spring or cable repair' },
  { icon: faDoorOpen,      label: 'New Door Install',    sub: 'Replace or add a new door' },
  { icon: faCogs,          label: 'Opener Install',      sub: 'New or replacement opener' },
  { icon: faClipboardList, label: 'Maintenance Plan',    sub: 'Tune-up, balance, safety check' },
  { icon: faBuilding,      label: 'Commercial Doors',    sub: 'Rolling steel & high-cycle' },
  { icon: faBolt,          label: 'Emergency',           sub: 'Door stuck, urgent repair needed' },
];
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    A licensed Summit Door Pros tech will reach out about your <strong>{selectedService}</strong> service.
                  </p>
