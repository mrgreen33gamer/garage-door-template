...
const personSchema = {
  ...
  "@type": "Person",
  name: "Marcus Hale",
  jobTitle: "Owner & IDA-Trained Technician",
  worksFor: {
    "@type": "Organization",
    name: "Summit Door Pros",
    url: "https://www.summitdoorpros.com",
  },
  url: "https://www.summitdoorpros.com/about",
  sameAs: [
    "https://www.facebook.com/summitdoorpros",
    "https://www.summitdoorpros.com",
  ],
  knowsAbout: [
    "garage door Panel Upgrades", "Residential Wiring", "EV Charger Installation",
    "Generator Installation", "garage door Safety", "Central Texas garage door Code",
  ],
  description:
    "Owner of Summit Door Pros in Waco, TX. IDA-trained technician with 15+ years powering Central Texas homes and businesses. Flat-rate pricing, Lifetime Spring Warranty + 2-Year Workmanship.",
};
    ...
    <section className={styles.authorBio} aria-label="About the Author">
      ...
      <div className={styles.card}>
        ...
        <div className={styles.content}>
          <p className={styles.role}>Owner & Lead Garage Door Technician · Summit Door Pros</p>
          <h2 className={styles.title}>Marcus Hale</h2>

          <p className={styles.description}>
            15+ years as a IDA-trained technician serving Central Texas
          ...
          <ul className={styles.credentials} aria-label="Credentials and specializations">
            <li>IDA-Trained Technician</li>
            <li>Panel upgrades, wiring, lighting, EV chargers &amp; generators</li>
            <li>5,000+ doors serviced completed across Central Texas</li>
            <li>Bonded, insured, Lifetime Spring Warranty + 2-Year Workmanship on every install</li>
          </ul>

          <p className={styles.updated}>
            Last updated April 2026 · Based on real local data &amp; 2026 Texas garage door safety standards
          </p>

          <div className={styles.footer}>
            <a
              href="https://www.facebook.com/summitdoorpros"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.linkedinLink}
              aria-label="Connect with Summit Door Pros on Facebook"
              onClick={() => trackEvent({
                eventType:    'click',
